...
чтобы проанадизировать разницу между тем что было заказагл и что было фактически доставлено
...
* проверка заполнения цены из соглашения 
	Тогда таблица "ItemList" содержит строки:
		| 'N' | 'Ед. изм.' | 'Номенклатура партнера' | 'Характеристика'          | 'Вид цены'          | 'Количество' | 'Цена'   | 'Номенклатура'            |
